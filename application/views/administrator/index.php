...
<head id="Head1">
    ...
    <title>EasyCiRbac权限管理</title>
    <link href="<?php echo $plugins;?>/easyui/css/default.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $plugins;?>/easyui/js/themes/default/easyui.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $plugins;?>/easyui/js/themes/icon.css" />
    <script type="text/javascript" src="<?php echo $plugins;?>/easyui/js/jquery-1.4.4.min.js"></script>
    <script type="text/javascript" src="<?php echo $plugins;?>/easyui/js/jquery.easyui.min.1.2.2.js"></script>
	<script type="text/javascript" src='<?php echo $plugins;?>/easyui/js/outlook2.js'> </script>
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; "><img src="<?php echo $plugins;?>/easyui/images/blocks.gif" width="20" height="20" align="absmiddle" />EasyCiRbac权限管理</span>
    </div>
    ...
    <div id="mainPanle" region="center" style="background: #eee; overflow-y:hidden">
        <div id="tabs" class="easyui-tabs"  fit="true" border="false" >
			<div title="欢迎使用" style="padding:20px;overflow:hidden; color:red; " >
				<h1 style="font-size:24px;">EasyCiRbac权限管理</h1>
<h1 style="font-size:24px;">基于Codeigniter框架</h1>
